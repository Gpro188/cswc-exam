        ...
        return (
          <React.Fragment key={center.id}>
                ...
                <div className="pack-cover-body">
                  <div className="pack-cover-meta-grid">
                    <div className="meta-row">
                      ...
                      <span className="meta-value bold">{center.centerName}</span>
                    </div>
                    <div className="meta-row">
            ...
            {sessions.map((session, sIdx) => {
              // The total count for the session is (number of subjects in session) * (count of students in center)
              const sessionTotalExpected = session.subjects.length * center.count;
                  ...
                  <div className="pack-cover-inner">
                    ...
                    <div className="pack-cover-body">
                        ...
                        <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: '16px', lineHeight: '1.8' }}>
                          ...
                          {session.subjects.map((sub, i) => (
                             <li key={i} style={{ paddingLeft: '20px', color: '#444', fontStyle: 'italic', marginBottom: '4px' }}>
                               - {sub.subject} ({center.count} papers)
                             </li>
                          ))}
                      ...
                      <div className="pack-cover-count-container" style={{ marginTop: '30px' }}>
                        ...
                        <div className="count-badge-large">{sessionTotalExpected}</div>
                        <div className="count-words">
                          (In Words: <strong>{numberToWords(sessionTotalExpected).toUpperCase()} ONLY</strong>)
                        </div>
                      </div>
                    </div>
            ...
            {data.timetable.map((subject, idx) => {
              ...
              return (
                <div key={`sub-${idx}`} className={`pack-cover-page ${shouldBreakAfter ? 'page-break-after' : ''}`}>
                  <div className="pack-cover-inner">
                    <div className="pack-cover-header">
                      <h2>Council of Samastha Womens Colleges (CSWC)</h2>
                      <h3>Fadheela PG Examination {data.year}</h3>
                    ...
                    <div className="pack-cover-body">
                      ...
                      <div className="pack-cover-count-container">
                        ...
                        <div className="count-badge-large">{center.count}</div>
                        <div className="count-words">
                          (In Words: <strong>{numberToWords(center.count).toUpperCase()} ONLY</strong>)
                        </div>
                      </div>
                    </div>
